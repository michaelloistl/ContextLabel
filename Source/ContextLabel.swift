...
open class ContextLabel: UILabel, NSLayoutManagerDelegate, UIGestureRecognizerDelegate {
    ...
    fileprivate func attributesWithTextColor(_ textColor: UIColor, underlineStyle: NSUnderlineStyle) -> [NSAttributedStringKey : Any] {
    ...
    fileprivate func linkResultsForURLs(inAttributedString attributedString: NSAttributedString) -> [LinkResult] {
        ...
        if let dataDetector = dataDetector {
            ...
            for match in matches {
                ...
                var realURL = attributedString.attribute(NSAttributedStringKey.link, at: matchRange.location, effectiveRange: nil)
                if realURL == nil {
